...
function Dashboard() {
  return (
<div id='dashboard' className="md:grid ml-4 flex flex-col relative gap-4 md:grid-cols-2">
  <div className="img-container bg-secondary">
    <img src={graphicImg} alt='finance dashboard graphic'/>
  </div>
  <div className="md:absolute md:top-1/2 md:left-1/2 md:transform md:-translate-y-1/2 ">
